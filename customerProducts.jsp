				...
				<div class="jumbotron">
					<f:view>
						...
						<h:form>
							...
							<br>
							<a href='<c:url value="/faces/customerPage.jsp" />'class="btn btn-default"><span class="glyphicon glyphicon-home"></span>Torna alla tua area riservata</a>
						</h:form>
					</f:view>
				</div>
			</div>
